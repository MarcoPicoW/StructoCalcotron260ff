...
% =========================================================
\providecommand{\h}{2.2}     % valore di default
\providecommand{\dicke}{0.6}
\newcommand{\sq}{0.2}
...
\pgfmathsetmacro{\diagonalx}{\hplus*tan(35)}

\tikzset{
  pics/square/.style={
    code={
      \draw[white, thick,fill=white,opacity=0.5] (0.2,0.2) rectangle (-0.2,-0.2);
      \draw[red, thick] (0.2,0.2) rectangle (-0.2,-0.2);
    }
  },
  pics/square_dashed/.style={
    code={
      \draw[white, thick,fill=white,opacity=0.5] (0.2,0.2) rectangle (-0.2,-0.2);
      \draw[red, thick, dashed] (0.2,0.2) rectangle (-0.2,-0.2);
    }
  },
  ...
  pics/L_Quer_line_mes/.style={
    code={
      \draw[red!90!black, thick] (-\LQuer,0) -- (\LQuer,0);
      \begin{scope}[color=red!90!black,opacity=0.5]
        \dimensioning{1}{-\LQuer,0}{\LQuer,0}{-0.7}[$L_{Quer}$];
      \end{scope}
    }
  },  
  pics/L_Quer_line/.style={
    code={
      \draw[red!90!black, thick] (-\LQuer,0) -- (\LQuer,0);
    }
  },
...
\point{CBtop}{-2.5}{1.2}
\point{DBtop}{-4.5}{1.2}
\point{Blue_square_bottom_left}{-\LQuer}{\NSA-0.2}
...
\pic at (B) {L_Quer_line_mes};
%\pic at (0,-0.2){L_Quer_line};
%\pic at (-2.5,0.1){L_Quer_line};
%\pic at (-4.5,0.2){L_Quer_line};
